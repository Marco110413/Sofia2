...
# Base de datos de usuarios y tokens
DB="tokens_db.json"
...
# Función para registrar usuario y comenzar a ganar tokens
registrar_usuario() {
    ...
    # Agregar usuario a la base de datos con tokens iniciales
